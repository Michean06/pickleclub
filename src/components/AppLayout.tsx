...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Mobile sidebar */}
      <div className={`fixed left-0 top-0 h-full z-40 lg:hidden transition-transform duration-300 ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 px-4 py-6 lg:px-8 xl:px-10 2xl:px-12 overflow-x-hidden">
